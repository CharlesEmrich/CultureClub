...
namespace CultureClub.Migrations
{
    ...
    [Migration("20170831202644_AddRatingsToUser")]
    partial class AddRatingsToUser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CultureClub.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CultureClub.Models.Movie", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CultureClub.Models.ApplicationUser")
                        .WithMany("Claims")
